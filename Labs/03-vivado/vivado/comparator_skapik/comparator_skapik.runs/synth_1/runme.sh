...
HD_PWD='D:/Documents/xskapi01/digital-electronics-1/Labs/03-vivado/vivado/comparator_skapik/comparator_skapik.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log comparator_skapik.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source comparator_skapik.tcl
