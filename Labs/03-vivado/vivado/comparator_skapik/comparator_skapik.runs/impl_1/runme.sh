...
HD_PWD='D:/Documents/xskapi01/digital-electronics-1/Labs/03-vivado/vivado/comparator_skapik/comparator_skapik.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log comparator_skapik.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source comparator_skapik.tcl -notrace
